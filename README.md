...
Currently working on NBA Finals prediction () yet ran out of time... Now working
Previously working on an NBA Finals prediction model — purely for data science, *not* gambling… probably. 😎
